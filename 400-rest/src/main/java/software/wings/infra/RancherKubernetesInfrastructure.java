...
public class RancherKubernetesInfrastructure implements InfraMappingInfrastructureProvider, KubernetesInfrastructure, FieldKeyValMapProvider, ProvisionerAware {
    ...
    @JsonIgnore
    private List<Map<String,String>> lableNames;
    @JsonIgnore
    private List<Map<String, String>> lableValues;
    ...
    public Set<String> getSupportedExpressions() {
        return ImmutableSet.of(
                RancherKubernetesInfrastructure.RancherKubernetesInfrastructureKeys.namespace, RancherKubernetesInfrastructure.RancherKubernetesInfrastructureKeys.releaseName);
    }
