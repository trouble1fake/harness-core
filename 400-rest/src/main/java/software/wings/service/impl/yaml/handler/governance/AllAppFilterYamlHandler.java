...
import io.harness.governance.AllAppFilterYaml;
...
public class AllAppFilterYamlHandler extends ApplicationFilterYamlHandler<AllAppFilterYaml, AllAppFilter> {
  @Inject private AppService appService;

  @Inject YamlHandlerFactory yamlHandlerFactory;

  @Override
  public AllAppFilterYaml toYaml(AllAppFilter bean, String accountId) {
    ...
    return AllAppFilterYaml.builder()
  ...
  public AllAppFilter upsertFromYaml(
      ChangeContext<AllAppFilterYaml> changeContext, List<ChangeContext> changeSetContext) {
  ...
  public Class getYamlClass() {
    return AllAppFilterYaml.class;
  }

  private void toBean(
      AllAppFilter bean, ChangeContext<AllAppFilterYaml> changeContext, List<ChangeContext> changeSetContext) {
    AllAppFilterYaml yaml = changeContext.getYaml();
