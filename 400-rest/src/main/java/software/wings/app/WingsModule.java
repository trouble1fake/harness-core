...
public class WingsModule extends AbstractModule implements ServersModule {
  ...
  protected void configure() {
   ...
   install(new DelegateServiceClassicGrpcClientModule(configuration.getPortal().getJwtNextGenManagerSecret(),configuration.getGrpcClientClassicConfig().getTarget(),configuration.getGrpcClientClassicConfig().getAuthority()));
