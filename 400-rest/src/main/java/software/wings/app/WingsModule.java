...
public class WingsModule extends AbstractModule implements ServersModule {
  ...
  protected void configure() {
    install(VersionModule.getInstance());package software.wings.app;
      ...
      public class WingsModule extends AbstractModule implements ServersModule {
          ...
          protected void configure() {
              ...
              if (configuration.isDisableDelegateMgmtInManager()) {
                  // Delegate Service Driver SDK grpc client config for DMS
                  ...
                  // Delegate Service Driver SDK grpc client config for manager
              ...
              // DMS classic grpc client config
