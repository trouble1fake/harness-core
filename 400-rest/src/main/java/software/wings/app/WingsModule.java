 ...
 */
    install(new DelegateServiceManagementDriverGrpcClientModule(
        configuration.getPortal().getJwtNextGenManagerSecret(), "localhost:14011", "localhost", false));

    install(new DelegateServiceClassicGrpcClientModule(
        configuration.getPortal().getJwtNextGenManagerSecret(), "localhost:15011", "localhost"));
