...
public class BuildSourceCleanupHelper {
  ...
  public BuildSourceCleanupHelper(String accountId, ArtifactStream artifactStream, List<BuildDetails> builds,
      ArtifactService artifactService, FeatureFlagService featureFlagService,
