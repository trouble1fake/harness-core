...
public class PivotalDeploymentManagerImplTest extends WingsBaseTest {
  ...
  //        PcfCreateApplicationRequestData.builder().cfRequestConfig(cfRequestConfig).build();
  ...
  //    when(client.getApplicationByName(eq(cfRequestConfig))).thenReturn(applicationDetail);
  //
  //    ApplicationDetail application = deploymentManager.createApplication(pcfCreateApplicationRequestData,
  //    logCallback); assertThat(application).isNotNull(); assertThat(application.getName()).isEqualTo(appName);
  ...
  //    verify(client, times(1)).unmapRoutesForApplicationUsingCli(eq(cfRequestConfig), eq(paths), eq(logCallback));
  //
  //    reset(client);
  //    cfRequestConfig.setUseCFCLI(false);
  //    deploymentManager.unmapRouteMapForApplication(cfRequestConfig, paths, logCallback);
  //    verify(client, times(1)).unmapRoutesForApplication(eq(cfRequestConfig), eq(paths));
  //
  //    reset(client);
  //    doThrow(Exception.class).when(client).unmapRoutesForApplication(eq(cfRequestConfig), eq(paths));
  ...
  //    verify(client, times(1)).mapRoutesForApplicationUsingCli(eq(cfRequestConfig), eq(paths), eq(logCallback));
  //
  //    reset(client);
  //    cfRequestConfig.setUseCFCLI(false);
  //    deploymentManager.mapRouteMapForApplication(cfRequestConfig, paths, logCallback);
  //    verify(client, times(1)).mapRoutesForApplication(eq(cfRequestConfig), eq(paths));
  //
  //    reset(client);
  //    doThrow(Exception.class).when(client).mapRoutesForApplication(eq(cfRequestConfig), eq(paths));
  ...
  //    CfRequestConfig cfRequestConfig = CfRequestConfig.builder().build();
  //
  //    when(client.getApplications(eq(cfRequestConfig))).thenReturn(Collections.emptyList());
  ...
  //    when(client.getApplications(eq(cfRequestConfig))).thenReturn(applicationSummaries);
  ...
  //    when(client.getApplications(eq(cfRequestConfig))).thenReturn(Arrays.asList(appSummary3, appSummary4));
  //    deployedServicesWithNonZeroInstances =
  //        deploymentManager.getDeployedServicesWithNonZeroInstances(cfRequestConfig, prefix);
  //    assertThat(deployedServicesWithNonZeroInstances).isNotNull();
  ...
  //
  //    reset(client);
  //    doThrow(Exception.class).when(client).getApplications(eq(cfRequestConfig));
  ...
  //    verify(client, times(1)).deleteApplication(eq(cfRequestConfig));
  //
  //    reset(client);
  //    doThrow(Exception.class).when(client).deleteApplication(eq(cfRequestConfig));
  ...
  //    verify(client, times(1)).stopApplication(eq(cfRequestConfig));
  //    assertThat(message.contains(appName)).isEqualTo(true);
  //
  //    reset(client);
  //    doThrow(Exception.class).when(client).stopApplication(eq(cfRequestConfig));
  ...
  //    when(client.getRouteMap(eq(cfRequestConfig), eq(tcpRouteNonRandomPortPath))).thenReturn(route);
  ...
  //
  //    reset(client);
  //    when(client.getRouteMap(eq(cfRequestConfig), eq(tcpRouteNonRandomPortPath))).thenReturn(Optional.empty());
  //    assertThatThrownBy(() -> deploymentManager.createRouteMap(cfRequestConfig, host, domain, path, true, false,
  //    port))
  //        .isInstanceOf(PivotalClientApiException.class);
  //
  ...
  //    when(client.getRouteMap(eq(cfRequestConfig), eq(tcpRouteRandomPortPath))).thenReturn(route);
  ...
  //    when(client.getRouteMap(eq(cfRequestConfig), eq(nonTcpRouteNonBlankPath))).thenReturn(route);
  ...
  //
  //    when(client.getApplicationEnvironmentsByName(eq(cfRequestConfig))).thenReturn(environments);
  //    assertThat(deploymentManager.isActiveApplication(cfRequestConfig, logCallback)).isEqualTo(true);
  //
  //    reset(client);
  //    when(client.getApplicationEnvironmentsByName(eq(cfRequestConfig)))
  ...
  //    doThrow(InterruptedException.class).when(client).getApplicationByName(eq(cfRequestConfig));
  //    assertThatThrownBy(() -> deploymentManager.upsizeApplicationWithSteadyStateCheck(cfRequestConfig, logCallback))
  //        .isInstanceOf(PivotalClientApiException.class);
  //
  //    reset(client);
  //    doReturn(applicationDetail).when(client).getApplicationByName(eq(cfRequestConfig));
