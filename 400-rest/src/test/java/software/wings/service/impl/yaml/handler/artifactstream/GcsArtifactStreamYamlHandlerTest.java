...
@OwnedBy(CDC)
public class GcsArtifactStreamYamlHandlerTest extends YamlHandlerTestBase {
  @InjectMocks @Inject private GcsArtifactStreamYamlHandler yamlHandler;
  ...
  public void toYaml() {
    GcsArtifactStream artifactStream = GcsArtifactStream.builder()
  ...
  public void upsertFromYaml() {
    ...
    final ArgumentCaptor<GcsArtifactStream> captor = ArgumentCaptor.forClass(GcsArtifactStream.class);
    yamlHandler.upsertFromYaml(changeContext, asList(changeContext));
    verify(artifactStreamService).createWithBinding(anyString(), captor.capture(), anyBoolean());
    final GcsArtifactStream artifactStream = captor.getValue();
    assertThat(artifactStream).isNotNull();
    assertThat(artifactStream.getArtifactStreamType()).isEqualTo(GCS.name());
    assertThat(artifactStream.getJobname()).isEqualTo("harness");
    assertThat(artifactStream.getProjectId()).isEqualTo("hello-world");
