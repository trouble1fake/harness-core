...
@JsonSubTypes({ @JsonSubTypes.Type(value = AwsCodeCommitSecretKeyAccessKey.class, name = ACCESS_KEY_AND_SECRET_KEY) })
public interface AwsCodeCommitHttpsCredentialsSpec extends DecryptableEntity {}