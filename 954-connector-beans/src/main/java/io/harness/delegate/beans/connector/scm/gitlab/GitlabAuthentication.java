...
public class GitlabAuthentication implements SourceCodeManagerAuthentication {
  ...
  @Builder
  public GitlabAuthentication(GitAuthType authType, GitlabCredentials credentials) {
