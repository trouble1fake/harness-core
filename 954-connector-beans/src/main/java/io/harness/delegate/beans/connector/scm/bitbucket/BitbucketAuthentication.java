...
public class BitbucketAuthentication implements SourceCodeManagerAuthentication {
  ...
  @Builder
  public BitbucketAuthentication(GitAuthType authType, BitbucketCredentials credentials) {
