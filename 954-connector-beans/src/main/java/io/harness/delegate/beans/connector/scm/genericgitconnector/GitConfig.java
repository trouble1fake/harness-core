...
public class GitConfig extends ConnectorConfigDTO implements ScmConnector, DelegateSelectable {
  ...
  @Valid
  @NotNull
  GitAuthentication gitAuth;

  @Builder
  public GitConfig(GitAuthType gitAuthType, GitAuthentication gitAuth, GitConnectionType gitConnectionType, String url,
      String validationRepo, String branchName, Set<String> delegateSelectors) {
