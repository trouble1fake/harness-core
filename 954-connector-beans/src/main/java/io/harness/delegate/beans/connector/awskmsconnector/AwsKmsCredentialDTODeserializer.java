...
public class AwsKmsCredentialDTODeserializer extends StdDeserializer<AwsKmsConnectorCredentialDTO> {
  ...
  @Override
  public AwsKmsConnectorCredentialDTO deserialize(JsonParser jp, DeserializationContext deserializationContext) throws IOException {
    ...
    return AwsKmsConnectorCredentialDTO.builder()
        .credentialType(type)
        .config(awsKmsCredentialSpecDTO)
        .build();
  }
