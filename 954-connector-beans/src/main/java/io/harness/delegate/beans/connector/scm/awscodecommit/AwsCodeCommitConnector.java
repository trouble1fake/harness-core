...
public class AwsCodeCommitConnector extends ConnectorConfigDTO implements ScmConnector, DelegateSelectable {
  ...
  @Builder
  public AwsCodeCommitConnector(AwsCodeCommitUrlType urlType, String url, AwsCodeCommitAuthentication authentication) {
  ...
  public List<DecryptableEntity> getDecryptableEntities() {
    ...
    if (authentication.getAuthType() == AwsCodeCommitAuthType.HTTPS) {
      AwsCodeCommitHttpsCredentialsSpec httpCredentialsSpec =
          ((AwsCodeCommitHttpsCredentials) authentication.getCredentials()).getHttpCredentialsSpec();
