...
public class AwsCodeCommitAuthentication implements SourceCodeManagerAuthentication {
  ...
  @Valid
  @NotNull
  AwsCodeCommitCredentials credentials;

  @Builder
  public AwsCodeCommitAuthentication(AwsCodeCommitAuthType authType, AwsCodeCommitCredentials credentials) {
