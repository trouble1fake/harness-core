...
public class GitlabHttpCredentials implements GitlabCredentials {
  ...
  @Builder
  public GitlabHttpCredentials(GitlabHttpAuthenticationType type, GitlabHttpCredentialsSpec httpCredentialsSpec) {
    this.type = type;
