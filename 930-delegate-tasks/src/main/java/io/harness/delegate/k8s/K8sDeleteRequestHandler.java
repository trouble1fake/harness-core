...
public class K8sDeleteRequestHandler extends K8sRequestHandler {
  ...
  protected K8sDeployResponse executeTaskInternal(K8sDeployRequest k8sDeployRequest,
    ...
    return executeDelete(k8sDeleteRequest, k8SDelegateTaskParams);
  }
  ...
  private K8sDeployResponse executeDelete(
      K8sDeleteRequest k8sDeleteRequest, K8sDelegateTaskParams k8sDelegateTaskParams) throws Exception {
    DeleteResourcesType deleteResourcesType = k8sDeleteRequest.getDeleteResourcesType();
    switch (deleteResourcesType) {
      case ResourceName:
      case ReleaseName:
        return executeDeleteUsingResources(k8sDeleteRequest, k8sDelegateTaskParams);
      case ManifestPath:
        return executeDeleteUsingFiles(k8sDeleteRequest, k8sDelegateTaskParams);
      default:
  ...
  private K8sDeployResponse executeDeleteUsingFiles(
      K8sDeleteRequest k8sDeleteRequest, K8sDelegateTaskParams k8sDelegateTaskParams) throws Exception {
    long steadyStateTimeoutInMillis = getTimeoutMillisFromMinutes(k8sDeleteRequest.getTimeoutIntervalInMin());

    startNewCommandUnit(FetchFiles, k8sDeleteRequest.isShouldOpenFetchFilesLogStream());
    boolean success = k8sTaskHelperBase.fetchManifestFilesAndWriteToDirectory(
        k8sDeleteRequest.getManifestDelegateConfig(), manifestFilesDirectory, getCurrentLogCallback(),
    ...
    initUsingFilePaths(k8sDeleteRequest, k8sDelegateTaskParams, getCurrentLogCallback());

    startNewCommandUnit(Delete, true);
    k8sTaskHelperBase.deleteManifests(client, resources, k8sDelegateTaskParams, getCurrentLogCallback(), true);
  ...
  void initUsingFilePaths(K8sDeleteRequest k8sDeleteRequest, K8sDelegateTaskParams k8sDelegateTaskParams,
    ...
    resources = k8sTaskHelperBase.getResourcesFromManifests(k8sDelegateTaskParams,
        ...
        k8sDeleteRequest.getValuesYamlList(), releaseName, k8sDeleteRequest.getK8sInfraDelegateConfig().getNamespace(),
  ...
  private K8sDeployResponse executeDeleteUsingResources(
      K8sDeleteRequest k8sDeleteRequest, K8sDelegateTaskParams k8sDelegateTaskParams) throws Exception {
    startNewCommandUnit(Init, true);
    init(k8sDeleteRequest, k8sDelegateTaskParams, getCurrentLogCallback());
    if (isEmpty(resourceIdsToDelete)) {
      return k8sDeleteBaseHandler.getSuccessResponse();
    }

    startNewCommandUnit(Delete, true);
    k8sTaskHelperBase.executeDelete(client, k8sDelegateTaskParams, resourceIdsToDelete, getCurrentLogCallback(), true);
    return k8sDeleteBaseHandler.getSuccessResponse();
  }
