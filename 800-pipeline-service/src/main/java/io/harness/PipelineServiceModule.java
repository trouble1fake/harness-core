  ...
  protected void configure() {
    ...
    install(OrchestrationModule.getInstance(
        OrchestrationModuleConfig.builder()
            ...
            .helperCorePoolSize(configuration.getOrchestrationHelperPoolConfig().getCorePoolSize())
            .helperMaxPoolSize(configuration.getOrchestrationHelperPoolConfig().getMaxPoolSize())
            .helperIdleTimeInSecs(configuration.getOrchestrationHelperPoolConfig().getIdleTime())
