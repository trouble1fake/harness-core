  ...
  protected void configure() {
    ...
    install(OrchestrationModule.getInstance(
        OrchestrationModuleConfig.builder()
            ...
            .sdkResponseCorePoolSize(configuration.getSdkResponseEventPoolConfig().getCorePoolSize())
            .sdkResponseMaxPoolSize(configuration.getSdkResponseEventPoolConfig().getMaxPoolSize())
            .sdkResponseIdleTimeInSecs(configuration.getSdkResponseEventPoolConfig().getIdleTime())
