...
public class ApprovalResourceServiceImpl implements ApprovalResourceService {
  ...
  public ApprovalInstanceResponseDTO addHarnessApprovalActivityCallback(@NotNull String approvalInstanceId,
    ...
    if (tmpInstance.getType() != ApprovalType.HARNESS_APPROVAL) {
