...
public class PipelineDashboardServiceImpl implements PipelineDashboardService {
  ...
  public DashboardPipelineHealthInfo getDashboardPipelineHealthInfo(String accountId, String orgId, String projectId,
    ...
    StatusAndTime statusAndTime = queryService.queryBuilderSelectStatusAndTime(
    ...
    // mean calculation
    long currentMean =
        queryService.queryBuilderMean(accountId, orgId, projectId, pipelineId, startInterval, endInterval, tableName);

    long previousMean = queryService.queryBuilderMean(
        accountId, orgId, projectId, pipelineId, previousStartInterval, startInterval, tableName);

    // Median calculation
    long currentMedian =
        queryService.queryBuilderMedian(accountId, orgId, projectId, pipelineId, startInterval, endInterval, tableName);

    long previousMedian = queryService.queryBuilderMedian(
        accountId, orgId, projectId, pipelineId, previousStartInterval, startInterval, tableName);
