...
public class PipelineResource implements YamlSchemaResource {
  ...
  private PipelineEntity createPipelineInternal(
      String accountId, String orgId, String projectId, PipelineEntity pipelineEntity) throws IOException {
  ...
  createPipeline(@Parameter(description = PipelineResourceConstants.ACCOUNT_PARAM_MESSAGE, required = true) @NotNull
    ...
    PipelineEntity createdEntity = createPipelineInternal(accountId, orgId, projectId, pipelineEntity);
  ...
  @Operation(operationId = "postPipelineV2", summary = "Create a Pipeline API (V2 Version)",
      responses =
      {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "default",
            description = "Returns created pipeline with metadata. New endpoint: createPipelineWithGovernance")
      })
  @NGAccessControlCheck(resourceType = "PIPELINE", permission = PipelineRbacPermissions.PIPELINE_CREATE_AND_EDIT)
  @Deprecated
  ...
  @Operation(operationId = "updatePipelineV2", summary = "Updates a Pipeline by identifier (V2 Version)",
      ...
      {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "default",
            description = "Returns updated pipeline with metadata. New endpoint: updatePipelineWithGovernance")
      })
  @NGAccessControlCheck(resourceType = "PIPELINE", permission = PipelineRbacPermissions.PIPELINE_CREATE_AND_EDIT)
  @Deprecated
  public ResponseDTO<PipelineSaveResponse>
