...
public class TemplateServicePactTest {
    @Rule
...
//
    ...
    public void runVersionTest() {
        String version = new TemplateServiceURLProvider(mockProvider.getUrl()).getVersion();
    ...
    public void runInvalidTest() {
        String invalid = new TemplateServiceURLProvider(mockProvider.getUrl()).getInvalidProperty();
