...
public class NGLicenseModule extends AbstractModule {
  @Override
  protected void configure() {
    ...
    for (ModuleType moduleType : ModuleType.values()) {
      objectMapperMapBinder.addBinding(moduleType).to(ModuleLicenseReistrarFactory.getLicenseObjectMapper(moduleType));
      interfaceMapBinder.addBinding(moduleType).to(ModuleLicenseReistrarFactory.getModuleLicenseClient(moduleType));
    }
