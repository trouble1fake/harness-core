...
public class AccountSettingCustomRepositoryImpl implements AccountSettingCustomRepository {
  ...
  @Override
  public List<AccountSettings> findAll(String accountId, String orgIdentifier, String projectIdentifier, String type) {
  ...
  public AccountSettings upsert(AccountSettings accountSettings, String accountIdentifier) {
    ...
    Update update =
        update(AccountSettings.AccountSettingsKeys.accountSettingConfig, accountSettings.getAccountSettingConfig());

    mongoTemplate.upsert(new Query(criteria), update, AccountSettings.class);
    return accountSettings;
  }

  @Override
  public AccountSettings findByScopeIdentifiersAndType(
      String accountId, String orgIdentifier, String projectIdentifier, String type) {
    Criteria criteria = Criteria.where(AccountSettings.AccountSettingsKeys.accountIdentifier)
                            .is(accountId)
                            .and(AccountSettings.AccountSettingsKeys.orgIdentifier)
                            .is(orgIdentifier)
