...
public class PmsSdkCoreEventsFrameworkModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    if (redisConfig.getRedisUrl().equals("dummyRedisUrl")) {
      ...
      bind(Producer.class)
          .annotatedWith(Names.named(SDK_INTERRUPT_RESPONSE_PRODUCER))
          .toInstance(NoOpProducer.of(EventsFrameworkConstants.DUMMY_TOPIC_NAME));
      ...
      bind(Producer.class)
          .annotatedWith(Names.named(SDK_INTERRUPT_RESPONSE_PRODUCER))
          .toInstance(RedisProducer.of(PIPELINE_SDK_INTERRUPT_TOPIC, redisConfig,
              EventsFrameworkConstants.PIPELINE_SDK_INTERRUPT_EVENT_MAX_TOPIC_SIZE, serviceName));
    }
  }
}
