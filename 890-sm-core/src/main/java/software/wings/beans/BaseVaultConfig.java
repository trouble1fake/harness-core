...
public abstract class BaseVaultConfig extends SecretManagerConfig {
  ...
  @Attributes(title = "Auth token") public @Encrypted(fieldName = "auth_token") String authToken;
  @Attributes(title = "AppRole Id") public String appRoleId;
  @Attributes(title = "Secret Id") public @Encrypted(fieldName = "secret_id") String secretId;
