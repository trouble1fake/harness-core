...
public interface NGEncryptorService {
  ...
  DecryptableEntity decryptEncryptionConfigSecrets2(DecryptableEntity decryptableEntity, List<EncryptedDataDetail> encryptedDataDetailList, String accountIdentifier);
