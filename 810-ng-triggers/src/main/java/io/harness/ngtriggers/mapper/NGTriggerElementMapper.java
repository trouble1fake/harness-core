...
public class NGTriggerElementMapper {
  ...
  public NGTriggerConfigV1 toTriggerConfig(String yaml) {
    try {
      return YamlPipelineUtils.read(yaml, NGTriggerConfigV1.class);
    } catch (IOException e) {
  ...
  public TriggerDetails toTriggerDetails(
    ...
    NGTriggerConfigV1 config = toTriggerConfig(yaml);
    NGTriggerEntity ngTriggerEntity =
        toTriggerEntity(accountIdentifier, orgIdentifier, projectIdentifier, config, yaml);
    return TriggerDetails.builder().ngTriggerConfigV1(config).ngTriggerEntity(ngTriggerEntity).build();
  }
  ...
  public NGTriggerEntity toTriggerEntity(
      String accountIdentifier, String orgIdentifier, String projectIdentifier, NGTriggerConfigV1 config, String yaml) {
  ...
  NGTriggerMetadata toMetadata(NGTriggerSourceV1 triggerSource) {
    switch (triggerSource.getType()) {
      case WEBHOOK:
        WebhookTriggerConfigV1 webhookTriggerConfig = (WebhookTriggerConfigV1) triggerSource.getSpec();

        WebhookMetadataBuilder metadata = WebhookMetadata.builder();
        if (webhookTriggerConfig.getType() != null) {
          metadata.type(webhookTriggerConfig.getType().name());
        }
  ...
  @VisibleForTesting
  GitMetadata prepareGitMetadata(WebhookTriggerConfigV1 webhookTriggerConfig) {
    ...
    if (gitAware != null) {
      return GitMetadata.builder().connectorRef(gitAware.getConnectorRef()).repoName(gitAware.getRepoName()).build();
    }
  ...
  public TriggerWebhookEventBuilder toNGTriggerWebhookEvent(String accountIdentifier, String orgIdentifier,
    ...
    TriggerWebhookEventBuilder triggerWebhookEventBuilder = TriggerWebhookEvent.builder()
                                                                ...
                                                                .orgIdentifier(orgIdentifier)
                                                                .projectIdentifier(projectIdentifier)
                                                                .sourceRepoType(webhookTriggerType.name())
