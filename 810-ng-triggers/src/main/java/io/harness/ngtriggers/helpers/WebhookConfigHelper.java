...
public class WebhookConfigHelper {
  ...
  public List<WebhookCondition> retrievePayloadConditions(WebhookTriggerConfigV2 webhookTriggerConfig) {
    PayloadAware payloadAware = null;
  ...
  public List<WebhookCondition> retrieveHeaderConditions(WebhookTriggerConfigV2 webhookTriggerConfig) {
    PayloadAware payloadAware = null;
    payloadAware = retrievePayloadAware(webhookTriggerConfig);
    if (payloadAware != null) {
