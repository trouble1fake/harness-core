...
public class WebhookTriggerFilterUtilTest extends CategoryTest {
  ...
  public void ConvertToLowerCaseTest() {
    assertThat(WebhookTriggerFilterUtils.convertToLowerCase("<+trigger.header['X-GitHub-Event']>"))
    ...
    assertThat(WebhookTriggerFilterUtils.convertToLowerCase("<+trigger.header['x-gituhb-event']>"))
        .isEqualTo("<+trigger.header['x-gituhb-event']>");

    assertThat(WebhookTriggerFilterUtils.convertToLowerCase("<+trigger.header['XGitHubEvent']>"))
        .isEqualTo("<+trigger.header['xgithubevent']>");

    assertThat(WebhookTriggerFilterUtils.convertToLowerCase("<+trigger.header[\"XGitHubEvent\"]>"))
        .isEqualTo("<+trigger.header['xgithubevent']>");

    assertThat(WebhookTriggerFilterUtils.convertToLowerCase("<+trigger.header['zzzz']>"))
    ...
    assertThat(WebhookTriggerFilterUtils.convertToLowerCase(null)).isEqualTo(null);
  }
