    ...
    return GitlabSpec.builder()
        ...
        .spec(GitlabPRSpec.builder()
                  ...
                  .payloadConditions(Arrays.asList(
                      WebhookCondition.builder().key("sourceBranch").operator(EQUALS).value("stage").build(),
                      WebhookCondition.builder().key("sourceBranch").operator(NOT_EQUALS).value("qa").build(),
