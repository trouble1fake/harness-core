...
import io.harness.serializer.kryo.VerificationCommonKryoRegistrar;
...
public class VerificationCommonsRegistrars {
  public static final ImmutableSet<Class<? extends KryoRegistrar>> kryoRegistrars =
      ImmutableSet.<Class<? extends KryoRegistrar>>builder().add(VerificationCommonKryoRegistrar.class).build();
