...
public class PerspectiveReportResource {
  ...
  @Operation(operationId = "getReportSetting",
      ...
      responses =
      {
        ...
        ApiResponse(description = "Returns a list of Report Schedules", content = {
  ...
  @Operation(operationId = "deleteReportSetting",
      ...
      {
        @io.swagger.v3.oas.annotations.responses.
        ApiResponse(description = "Returns a generic string message when the operation is successful", content = {
          @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = ResponseDTO.class))
        })
      })
