...
public class CCMConnectorValidationResource {
    ...
    public RestResponse<ConnectorValidationResult> testConnection(@QueryParam(NGCommonEntityConstants.ACCOUNT_KEY) String accountId, ConnectorResponseDTO connectorResponseDTO) {
