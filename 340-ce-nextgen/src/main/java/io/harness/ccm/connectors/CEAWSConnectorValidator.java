...
public class CEAWSConnectorValidator {
    ...
    public static ConnectorValidationResult validate(ConnectorResponseDTO connectorResponseDTO, String accountIdentifier) {
        final CEAwsConnectorDTO ceAwsConnectorDTO = (CEAwsConnectorDTO) connectorResponseDTO.getConnector().getConnectorConfig();
        ...
        try {
            ...
            if (featuresEnabled.contains(CEFeatures.BILLING)) {
                ...
                AWSSecurityTokenServiceException ex) {
            return ConnectorValidationResult.builder()
                ...
                AmazonIdentityManagementException ex) {
