...
public class CEAzureConnectorValidator {
    ...
    @Inject
    private static CEAzureSetupConfig ceAzureSetupConfig;

    public static ConnectorValidationResult validate(ConnectorResponseDTO connectorResponseDTO, String accountIdentifier) {
        final CEAzureConnectorDTO ceAzureConnectorDTO = (CEAzureConnectorDTO) connectorResponseDTO.getConnector().getConnectorConfig();
