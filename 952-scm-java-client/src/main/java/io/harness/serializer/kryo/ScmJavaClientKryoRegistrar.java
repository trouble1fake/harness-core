...
public class ScmJavaClientKryoRegistrar implements KryoRegistrar {
  ...
  public void register(Kryo kryo) {
    ...
    kryo.register(ListBranchesResponse.class, 955007);
    kryo.register(ListCommitsResponse.class, 955008);
    kryo.register(ScmException.class, 955009);
    kryo.register(FileBatchContentResponse.class, 955010);
    kryo.register(FileContent.class, 955011);
  }
}