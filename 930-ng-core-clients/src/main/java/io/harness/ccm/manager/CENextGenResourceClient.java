...
public interface CENextGenResourceClient {
  ...
  @POST(BASE_API + "/testConnection")
  Call<ResponseDTO<ConnectorValidationResult>> testConnection(
          @NotEmpty @Query(NGCommonEntityConstants.ACCOUNT_KEY) String accountIdentifier, @Body ConnectorResponseDTO connectorResponseDTO);
}
