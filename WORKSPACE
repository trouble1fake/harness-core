...
#        maven_test_artifact("au.com.dius.pact.provider:junit5:4.1.21"),
#        maven_test_artifact("au.com.dius:pact-jvm-provider-junit_2.11:3.5.0"),
#        maven_test_artifact("au.com.dius:pact-jvm-provider-junit:4.0.10"),
#        maven_test_artifact("au.com.dius.pact.provider:junit5spring:4.3.4")
        maven_test_artifact("au.com.dius.pact.provider:junit:4.1.33"),
    ],
    excluded_artifacts = [],
