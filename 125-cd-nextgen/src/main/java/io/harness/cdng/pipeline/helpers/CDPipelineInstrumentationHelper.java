...
public class CDPipelineInstrumentationHelper {
    ...
    private long getTotalNumberOfActiveServices(String accountIdentifier, String organizationId, String projectId, long startInterval, long endInterval) {
        return getTotalNumberOfActiveServices(getServiceInstancesInInterval(accountIdentifier, organizationId, projectId, startInterval, endInterval));
    }
    ...
    public List<InstanceDTO> getServiceInstancesInInterval(String accountIdentifier, String organizationId, String projectId, long startInterval, long endInterval) {
        ...
        try {
            if (EmptyPredicate.isEmpty(organizationId) && EmptyPredicate.isEmpty(projectId)) {
                ...
                totalServiceInstances.addAll(instanceService.getInstancesDeployedInInterval(accountIdentifier, organizationId, projectId, startInterval, endInterval));
            }
        } catch (Exception e) {
    ...
    public void sendCountOfDistinctActiveServicesEvent(
            String pipelineId, String identity, String accountId, String accountName, String orgId, String projectId, List<InstanceDTO> serviceInstances) {
    ...
    public void sendCountOfServiceInstancesEvent(
            String pipelineId, String identity, String accountId, String accountName,
    ...
    public void sendServiceUsedEventsForPipelineExecution(String eventPipelineId, String identity, String accountId, String accountName,
                                                          String orgId, String projectId, String planExecutionId, OrchestrationEvent event) {
        Set<String> serviceIds = getServiceIdsForPipelineExecution(event);

        serviceIds.forEach(serviceId ->
                sendServiceUsedInPipelineExecutionEvent(eventPipelineId, identity, accountId, accountName,
                        orgId, projectId, planExecutionId, serviceId));
    }

    private void sendServiceUsedInPipelineExecutionEvent(
            String eventPipelineId, String identity, String accountId, String accountName,
            String orgId, String projectId, String planExecutionId, String serviceId) {
        try {
