...
public class CDCreatorUtils {
  public Set<String> getSupportedSteps() {
    return Sets.newHashSet("K8sBGSwapServices", "K8sDelete", "K8sCanaryDelete", "TerraformApply", "TerraformPlan",
  ...
  public Set<String> getSupportedStepsV2() {
    return Sets.newHashSet(
        "K8sCanaryDeploy", "K8sApply", "K8sBlueGreenDeploy", "K8sRollingDeploy", "K8sRollingRollback", "K8sScale");
  }
}
