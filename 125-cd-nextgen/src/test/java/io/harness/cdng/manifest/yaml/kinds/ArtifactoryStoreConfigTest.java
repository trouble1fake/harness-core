...
public class ArtifactoryStoreConfigTest extends CategoryTest {
    ...
    public void testApplyOverrides(){
        ArtifactoryStoreConfig origin = CreateMockArtifactoryStoreConfig(MOCK_CONNECTOR_REF, MOCK_ARTIFACT_NAME,
                MOCK_REPOSITORY_PATH, MOCK_VERSION);
        ...
        checkArtifactoryStoreConfigParameters(origin, override, MOCK_CONNECTOR_REF_OVERWRITE, MOCK_ARTIFACT_NAME_OVERWRITE, MOCK_REPOSITORY_PATH_OVERWRITE, MOCK_VERSION_OVERWRITE);
    }
    ...
    public void testApplyOverridesEmpty(){
        ...
        checkArtifactoryStoreConfigParameters(origin, override, MOCK_CONNECTOR_REF, MOCK_ARTIFACT_NAME, MOCK_REPOSITORY_PATH, MOCK_VERSION);
    }
    ...
    private void checkArtifactoryStoreConfigParameters(ArtifactoryStoreConfig origin, ArtifactoryStoreConfig override, String mockConnectorRef, String mockArtifactName, String mockRepositoryPath, String mockVersion) {
    ...
    private ArtifactoryStoreConfig CreateMockArtifactoryStoreConfig(String mockConnector, String mockArtifact,
                                                  String mockRepository, String mockVersion) {
