...
public class CDPipelineInstrumentationHelperTest extends CategoryTest {
    ...
    public void testGetServiceInstancesInIntervalException() {
        ...
        List<InstanceDTO> serviceInstances2 = cdPipelineInstrumentationHelper.getServiceInstancesInInterval(accountId, orgId, projectId, startInterval, endInterval);
    ...
    public void testSendCountOfDistinctActiveServicesEvent() {
        ...
        cdPipelineInstrumentationHelper.sendCountOfDistinctActiveServicesEvent(pipelineId, identity, accountId, accountName, orgId, projectId);

        ArgumentCaptor<HashMap> captor = ArgumentCaptor.forClass(HashMap.class);
        verify(telemetryReporter, times(1)).sendTrackEvent(
                any(), any(), any(), captor.capture(), any(), any(), any());
    ...
    public void testSendCountOfServiceInstancesEvent() {
        ...
        cdPipelineInstrumentationHelper.sendCountOfServiceInstancesEvent(pipelineId, identity, accountId, accountName, orgId, projectId, instancesList);
    ...
    public void testSendServiceUsedEventsForPipelineExecution() {
        ...
        CDPipelineModuleInfo cdPipelineModuleInfo = CDPipelineModuleInfo.builder()
                .serviceIdentifiers(serviceIds)
                .build();
        OrchestrationEvent event = OrchestrationEvent.builder()
                .moduleInfo(cdPipelineModuleInfo)
                .build();
        ...
        cdPipelineInstrumentationHelper.sendServiceUsedEventsForPipelineExecution(
                ...
                planExecutionId, event);

        verify(telemetryReporter, times(3)).sendTrackEvent(
    ...
    public void testSendServiceUsedEventsForPipelineExecutionWithoutModuleInfo() {
        ...
        verify(telemetryReporter, times(0)).sendTrackEvent(
                any(), any(), any(), any(), any(), any(), any());
