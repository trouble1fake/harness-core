  ...
  public static List<MongoIndex> mongoIndexes() {
    return ImmutableList.<MongoIndex>builder()
        .add(SortCompoundMongoIndex.builder()
                 .name("ngAuditTimeScopeModuleActionPrincipalResourceIdx")
                 ...
                 .build())
        .add(SortCompoundMongoIndex.builder()
                 .name("ngAuditTimeScopeModuleActionResourceIdx")
                 .descSortField(AuditEventKeys.timestamp)
                 .field(AuditEventKeys.ACCOUNT_IDENTIFIER_KEY)
                 .field(AuditEventKeys.ORG_IDENTIFIER_KEY)
                 .field(AuditEventKeys.PROJECT_IDENTIFIER_KEY)
        ...
        .add(SortCompoundMongoIndex.builder()
                 ...
                 .build())
        .add(SortCompoundMongoIndex.builder()
                 .name("ngAuditTimeScopeActionPrincipalResourceIdx")
                 .descSortField(AuditEventKeys.timestamp)
                 .field(AuditEventKeys.ACCOUNT_IDENTIFIER_KEY)
                 .field(AuditEventKeys.ORG_IDENTIFIER_KEY)
                 .field(AuditEventKeys.PROJECT_IDENTIFIER_KEY)
                 ...
                 .build())
        .add(SortCompoundMongoIndex.builder()
                 .name("ngAuditTimeScopeActionResourceIdx")
                 .descSortField(AuditEventKeys.timestamp)
                 .field(AuditEventKeys.ACCOUNT_IDENTIFIER_KEY)
                 .field(AuditEventKeys.ORG_IDENTIFIER_KEY)
                 .field(AuditEventKeys.PROJECT_IDENTIFIER_KEY)
        ...
        .add(SortCompoundMongoIndex.builder()
                 ...
                 .build())
        .add(SortCompoundMongoIndex.builder()
                 .name("ngAuditTimeScopeResourceLabelTypeIdx")
                 .descSortField(AuditEventKeys.timestamp)
                 .field(AuditEventKeys.ACCOUNT_IDENTIFIER_KEY)
                 .field(AuditEventKeys.ORG_IDENTIFIER_KEY)
                 .field(AuditEventKeys.PROJECT_IDENTIFIER_KEY)
