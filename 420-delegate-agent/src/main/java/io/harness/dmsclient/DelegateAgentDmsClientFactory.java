...
public class DelegateAgentDmsClientFactory implements Provider<DelegateAgentDmsClient> {
  public static final ImmutableList<TrustManager> TRUST_ALL_CERTS =
      ImmutableList.of(new DelegateAgentDmsClientX509TrustManager());
  ...
  public DelegateAgentDmsClientFactory(String baseUrl, TokenGenerator tokenGenerator) {
  ...
  private OkHttpClient getSafeOkHttpClient() {
    try {
      ...
      return Http.getOkHttpClientWithProxyAuthSetup()
          ...
          // During this call we not just query the task but we also obtain the secret on the dms side
