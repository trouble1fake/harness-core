...
//    }
    ...
    public RequestResponsePact createPactInvalid(PactDslWithProvider builder) {
        System.out.println("inside createPact");
...
//        String version = new VerificationURLProvider(mockProvider.getUrl()).getVersion();
...
//    }
    ...
    public void runInvalidTest() {
        ...
        String invalid = new VerificationURLProvider(mockProvider.getUrl()).getInvalidProperty();
