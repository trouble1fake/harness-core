...
public class NGLogCallback implements LogCallback {
  ...
  public NGLogCallback(
          ILogStreamingTaskClient iLogStreamingTaskClient, String commandUnitName, boolean shouldOpenStream, CommandUnitsProgress commandUnitsProgress) {
  ...
  public void saveExecutionLog(String line, LogLevel logLevel, CommandExecutionStatus commandExecutionStatus) {
    ...
    LinkedHashMap<String, CommandUnitProgress> commandUnitProgressMap = commandUnitsProgress.getCommandUnitProgressMap();
    CommandUnitProgress.CommandUnitProgressBuilder commandUnitProgressBuilder = CommandUnitProgress.builder().status(commandExecutionStatus);
    ...
    taskProgressClient.sendTaskProgressUpdate(commandUnitsProgress);
  }
