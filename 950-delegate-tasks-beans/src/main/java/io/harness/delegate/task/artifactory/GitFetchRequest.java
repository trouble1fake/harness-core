...
public class GitFetchRequest  implements ActivityAccess, TaskParameters, ExecutionCapabilityDemander {
    private List<ArtifactoryFetchFilesConfig> artifactoryFetchFilesConfigs;
    ...
    public List<ExecutionCapability> fetchRequiredExecutionCapabilities(ExpressionEvaluator maskingEvaluator) {
        ...
        for (ArtifactoryFetchFilesConfig config : artifactoryFetchFilesConfigs) {
            ArtifactoryStoreDelegateConfig storeConfig = config.getArtifactoryStoreDelegateConfig();
