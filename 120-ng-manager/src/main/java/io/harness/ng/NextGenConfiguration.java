...
public class NextGenConfiguration extends Configuration {
  ...
  public static final String PAYMENT_RESOURCE = "io.harness.payment.resources";
    ...
    return HarnessReflections.get()
        ...
        .filter(klazz
            -> StringUtils.startsWithAny(klazz.getPackage().getName(), CORE_PACKAGE, CONNECTOR_PACKAGE,
                ...
                INVITE_PACKAGE, USER_PACKAGE, INSTANCE_NG_PACKAGE, SMTP_NG_RESOURCE, PAYMENT_RESOURCE, SCIM_NG_RESOURCE))
