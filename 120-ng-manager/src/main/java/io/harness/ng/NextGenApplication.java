...
import io.harness.ng.accesscontrol.migrations.AccessControlMigrationManagedService;
...
public class NextGenApplication extends Application<NextGenConfiguration> {
  ...
  private void registerManagedBeans(Environment environment, Injector injector) {
    ...
    environment.lifecycle().manage(injector.getInstance(AccessControlMigrationManagedService.class));
