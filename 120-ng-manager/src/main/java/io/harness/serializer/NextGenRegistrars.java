...
import io.harness.serializer.morphia.MigrationMorphiaRegistrar;
import io.harness.serializer.morphia.MigrationMorphiaRegistrars;
...
public class NextGenRegistrars {
  ...
  public static final ImmutableSet<Class<? extends MorphiaRegistrar>> morphiaRegistrars =
      ImmutableSet.<Class<? extends MorphiaRegistrar>>builder()
          ...
          .add(MigrationMorphiaRegistrars.class)
          .add(MigrationMorphiaRegistrar.class)
          .build();
