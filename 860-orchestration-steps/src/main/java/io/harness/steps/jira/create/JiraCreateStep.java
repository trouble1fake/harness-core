...
@OwnedBy(CDC)
public class JiraCreateStep implements TaskExecutable<JiraCreateStepParameters> {
  ...
  public TaskRequest obtainTask(
    ...
    JiraTaskNGParametersBuilder paramsBuilder =
        JiraTaskNGParameters.builder()
            ...
            .issueKey(stepParameters.getIssueType().getValue())
    ...
    return jiraTaskHelperService.prepareTaskRequest(paramsBuilder, ambiance,
        stepParameters.getConnectorRef().getValue(), stepParameters.getTimeout().getValue(), "Create Jira Issue Task");
  }

  @Override
  public StepResponse handleTaskResult(
      Ambiance ambiance, JiraCreateStepParameters stepParameters, Map<String, ResponseData> responseDataMap) {
    ...
    if (notifyResponseData instanceof ErrorNotifyResponseData) {
      ...
      JiraTaskNGResponse taskResponse = (JiraTaskNGResponse) notifyResponseData;
