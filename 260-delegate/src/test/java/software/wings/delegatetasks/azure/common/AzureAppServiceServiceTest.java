...
public class AzureAppServiceServiceTest extends WingsBaseTest {
  ...
  public void testGetAzureAppServicePreDeploymentData() {
    ...
    AzureAppServicePreDeploymentData azureAppServicePreDeploymentData =
        azureAppServiceService.getAzureAppServicePreDeploymentData(azureWebClientContext, SLOT_NAME, TARGET_SLOT_NAME,
            userAddedAppSettings, userAddedConnSettings, logStreamingTaskClient);
    ...
    assertThatThrownBy(()
                           -> azureAppServiceService.getAzureAppServicePreDeploymentData(azureWebClientContext, "",
    ...
    assertThatThrownBy(
        ()
            -> azureAppServiceService.getAzureAppServicePreDeploymentData(azureWebClientContext, SLOT_NAME,
                TARGET_SLOT_NAME, userAddedAppSettings, userAddedConnSettings, logStreamingTaskClient))
        .isInstanceOf(Exception.class);
  }
