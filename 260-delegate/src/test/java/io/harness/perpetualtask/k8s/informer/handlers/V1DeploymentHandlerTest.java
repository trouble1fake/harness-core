...
public class V1DeploymentHandlerTest extends CategoryTest {
  ...
  private final ClusterDetails clusterDetails = ClusterDetails.builder()
                                                    ...
                                                    .build();
  private V1DeploymentHandler deploymentHandler;
  private ArgumentCaptor<Message> captor;

  @Before
  public void setUp() throws Exception {
    eventPublisher = mock(EventPublisher.class);
    deploymentHandler = new V1DeploymentHandler(eventPublisher, clusterDetails);
  ...
  public void shouldPublishWorkloadSpecOnAdd() throws Exception {
    V1Deployment deployment = new V1DeploymentBuilder()
                                  ...
                                  .endSpec()
                                  .build();
    deploymentHandler.onAdd(deployment);
  ...
  public void shouldPublishWorkloadSpecOnUpdateIfChangeMade() throws Exception {
    ...
    V1Deployment newDeployment = new V1DeploymentBuilder(oldDeployment)
                                     ...
                                     .endSpec()
                                     .build();
    deploymentHandler.onUpdate(oldDeployment, newDeployment);
