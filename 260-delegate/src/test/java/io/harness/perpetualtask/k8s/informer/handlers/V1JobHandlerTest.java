...
public class V1JobHandlerTest extends CategoryTest {
  ...
  private final ClusterDetails clusterDetails = ClusterDetails.builder()
                                                    ...
                                                    .build();
  private V1JobHandler jobHandler;
  private ArgumentCaptor<Message> captor;

  @Before
  public void setUp() throws Exception {
    eventPublisher = mock(EventPublisher.class);
    jobHandler = new V1JobHandler(eventPublisher, clusterDetails);
  ...
  public void shouldPublishWorkloadSpecOnUpdateIfChangeMade() throws Exception {
    V1Job oldJob = new V1JobBuilder()
                       ...
                       .endSpec()
                       .build();
    V1Job newJob = new V1JobBuilder(oldJob)
                       .withNewSpec()
                       .withNewTemplate()
                       .withNewSpec()
                       .addNewInitContainer()
                       ...
                       .endSpec()
                       .build();
    jobHandler.onUpdate(oldJob, newJob);
