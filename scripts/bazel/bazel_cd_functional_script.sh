...
if [ "${RUN_BAZEL_FUNCTIONAL_TESTS}" == "true" ]; then
  java -Xmx4096m -XX:+HeapDumpOnOutOfMemoryError -XX:+PrintGCDetails -XX:+PrintGCDateStamps -Xloggc:mygclogfilename.gc -XX:+UseParallelGC -XX:MaxGCPauseMillis=500 -jar /home/jenkins/workspace/cdp-deployment-functional-tests/260-delegate/target/delegate-capsule.jar /home/jenkins/workspace/cdp-deployment-functional-tests/260-delegate/config-delegate.yml &
