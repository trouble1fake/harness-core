...
public class VmRunTestStepSerializer {
    public VmRunTestStep serialize(
            RunTestsStepInfo runTestsStepInfo, String identifier, ParameterField<Timeout> parameterFieldTimeout, String stepName) {
        ...
        VmRunTestStep.VmRunTestStepBuilder runTestStepBuilder = VmRunTestStep.builder()
                .image(image)
                .args(args)
