...
public class DelegateListDataFetcher
    extends AbstractConnectionV2DataFetcher<io.harness.app.schema.query.delegate.QLDelegateFilter, QLNoOpSortCriteria, QLDelegateList> {
  @Override
  protected io.harness.app.schema.query.delegate.QLDelegateFilter generateFilter(DataFetchingEnvironment environment, String key, String value) {
    return null;
  }

  @Override
  @AuthRule(permissionType = PermissionAttribute.PermissionType.LOGGED_IN)
  protected QLDelegateList fetchConnection(List<io.harness.app.schema.query.delegate.QLDelegateFilter> filters, QLPageQueryParameters pageQueryParameters,
