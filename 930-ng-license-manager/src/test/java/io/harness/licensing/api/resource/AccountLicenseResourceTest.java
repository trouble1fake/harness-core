...
public class AccountLicenseResourceTest extends LicenseTestBase {
  ...
  public void testGet() {
    ...
    ResponseDTO<AccountLicenseDTO> responseDTO = licenseResource.get("1", ACCOUNT_IDENTIFIER);
    Mockito.verify(licenseService, times(1)).getAccountLicenseById("1");
    assertThat(responseDTO.getData()).isNotNull();
  }
  ...
  public void testStartTrial() {
    ...
    ResponseDTO<ModuleLicenseDTO> responseDTO = licenseResource.startTrial(ACCOUNT_IDENTIFIER, startTrialRequestDTO);
