...
@TypeAlias("io.harness.license.entities.transactions.modules.CDLicenseTransaction")
public class CDLicenseTransaction extends LicenseTransaction {
  private Integer workload;

  @Override
  public LicenseTransaction makeTemplateCopy() {
    return CDLicenseTransaction.builder()
