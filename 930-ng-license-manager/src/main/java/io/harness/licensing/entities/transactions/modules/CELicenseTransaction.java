...
@TypeAlias("io.harness.license.entities.transactions.modules.CELicenseTransaction")
public class CELicenseTransaction extends LicenseTransaction {
  @Override
  public LicenseTransaction makeTemplateCopy() {
    return CELicenseTransaction.builder()
