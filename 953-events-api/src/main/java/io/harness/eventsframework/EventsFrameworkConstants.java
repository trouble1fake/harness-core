...
public final class EventsFrameworkConstants {
  ...
  public static final String CD_DEPLOY_INFO_EVENT = "cd_deployment_info";
  public static final int CD_DEPLOY_INFO_EVENT_BATCH_SIZE = 1;
  public static final int CD_DEPLOY_INFO_EVENT_EVENT_MAX_TOPIC_SIZE = 5000;
  ...
  public static final Duration CD_DEPLOY_INFO_EVENT_EVENT_MAX_PROCESSING_TIME = Duration.ofSeconds(20);
